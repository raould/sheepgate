...
import { hiscore_sfx_b64 } from './hiscore.ogg.b64';
import { wiggle_sfx_b64 } from './wiggle.ogg.b64';
...
const f2d_pow = Math.pow(10, 2);
function f2d(f: number): number {
    return Math.floor(f * f2d_pow)/f2d_pow;
}
...
function loadImages() {
    ...
    loadExplosionA("explosionB", "ex", 1, 6);
    loadExplosionA("explosionCbm", "cboom", 0, 6);
}
