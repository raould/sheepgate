...
const LKfn = (level_index: number): Lta.LevelKonfig => {
	...
	Ebs1: { mk: Ezx1.warpin_mk, count: 5 + buf, limit: 3 + buf, delay_msec: 1000, tick_msec: 3*1000 },
	Es: { mk: Es.warpin_mk, count: 4 + buf, limit: 2 + buf, delay_msec: 1000, tick_msec: 3*1000 },
	Em: { mk: Em.warpin_mk, count: 3 + buf, limit: 1 + buf, delay_msec: 1000, tick_msec: 3*1000 },
