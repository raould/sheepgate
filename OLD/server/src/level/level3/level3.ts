...
const LKfn = (level_index: number): Lta.LevelKonfig => {
	...
	Eb3: { mk: Eb3.warpin_mk, count: 8 + buf, limit: 6 + buf, delay_msec: 1000, tick_msec: 3*1000 },
	Eb7: { mk: Eb7.warpin_mk, count: 8 + buf, limit: 6 + buf, delay_msec: 1000, tick_msec: 3*1000 },
	Ep: { mk: Ep.warpin_mk, count: 2 + buf, limit: 2 + buf, delay_msec: 5*1000, tick_msec: 3*1000 },
