...
import Ecbm1 from './enemy_basic1';
...
const LKfn = (level_index: number): Lta.LevelKonfig => {
	...
	Es: { mk: Es.warpin_mk, count: 5 + buf, limit: 2 + buf, delay_msec: 10*1000, tick_msec: 3*1000 },
	Em: { mk: Em.warpin_mk, count: 4 + buf, limit: 1 + buf, delay_msec: 3*1000, tick_msec: 3*1000 },
