...
const SIZE = K.vd2si(G.v2d_scale_i(G.v2d_mk(90, 90), 1.8));
const WARPIN_RESOURCE_ID = "enemies/e8/e8.png";
    ...
    tspecs.forEach(spec => {
        ...
        table.push({
            ...
            animator: A.animator_mk(
                db.shared.sim_now,
                {
                    resource_id: images.lookup(`enemies/e8/e8.png`),
                }
            )
        });
    });
