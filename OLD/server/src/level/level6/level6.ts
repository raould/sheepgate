...
const LKfn = (level_index: number): Lta.LevelKonfig => {
    ...
    return {
	Eb3: { mk: Eb3.warpin_mk, count: 4 + buf, limit: 2 + buf, delay_msec: 1000, tick_msec: 1000 },
	Eb6: { mk: Eb6.warpin_mk, count: 4 + buf, limit: 2 + buf, delay_msec: 1000, tick_msec: 1000 },
	Eb8: { mk: Eb8.warpin_mk, count: 4 + buf, limit: 4 + buf, delay_msec: 1000, tick_msec: 1000 },
