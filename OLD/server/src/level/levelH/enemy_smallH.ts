...
export const SIZE = K.vd2si(G.v2d_scale_i(G.v2d_mk(100, 101), 0.6));
export const WARPIN_RESOURCE_ID = "enemies/e27/e7s1.png";
        ...
        table.push({
            ...
            animator: A.animator_mk(
                db.shared.sim_now,
                {
                    frame_msec: 80,
                    resource_ids: [
                        ...images.lookup_range_n(n => `enemies/e27/e7s${n}.png`, 0, 3),
                    ],
