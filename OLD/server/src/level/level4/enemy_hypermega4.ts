...
export const SIZE = G.v2d_scale(G.v2d_mk(90, 109), 1);
export const WARPIN_RESOURCE_ID = "enemies/e20/g1.png";
...
function anims_spec_mk(db: GDB.GameDB): A.AnimatorDimensionsSpec {
    const frames: A.DimensionsFrame[] = [
        // enemy e20 doesn't show any thrusters.
...
function t2a_facing_mk(db: GDB.GameDB, thrusting: boolean, facing: F.Facing): A.DimensionsFrame[] {
    ...
    tspecs.forEach(spec => {
        ...
        table.push({
		    ...
		    frame_msec: 200,
                    resource_ids: [
                        ...images.lookup_range_n(n => `enemies/e20/g${n}.png`, 1, 3)
                    ],
