...
export function safe_lt(db: GDB.GameDB, rank: S.Rank, size: G.V2D, rnd: Rnd.Random, lt: G.V2D | undefined): G.V2D {
    ...
    const sltve = safe_lt_vs_enemy(db, rank, size, rnd, slt);
...
export function safe_lt_vs_enemy(db: GDB.GameDB, rank: S.Rank, size: G.V2D, rnd: Rnd.Random, lt: G.V2D): G.V2D {
